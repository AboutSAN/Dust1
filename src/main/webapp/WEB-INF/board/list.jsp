   ...
   <div class="container">
     <div class="row">
       ...
       <table class="table">
          <tr>
             <td>
                <a href="insert.do" class="btn btn-xs" style="background-color:#4682B4; color:white">새글</a>
             </td>
          </tr>
       </table>
       ...
       <table class="table">
          <tr>
             ...
             <td class="text-right">
                 ...
                 <a href="#" class="btn btn-xs" style="background-color:#4682B4; color:white">다음</a>
             </td>
          </tr>
       </table>
     </div>
